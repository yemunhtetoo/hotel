            ...
            <div class="row align-items-center">
                <div class="col">
                    <div class="mt-5">
                        ...
                        <a href="{{route('form/booking/edit')}}" class="btn btn-primary float-right veiwbutton ">Add Booking</a>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="{{url('assets/img/profiles/avatar-03.jpg')}}" alt="User Image"></a>
